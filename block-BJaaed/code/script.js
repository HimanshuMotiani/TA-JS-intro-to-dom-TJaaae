...
{/* <article class="flex-32 article">
          <div>
            <img class="flexible-width" src="https://eloquentjavascript.net/img/cover.jpg">
          </div>
           <h3>Eloquent JavaScript, Second Edition</h3>
           <h5>Marijn Haverbeke</h5>
           <div >
...
article.classList.add("flex-31","article")
...
h5.innerText = item.author
let input = document.createElement("input")
input.classList.add("btn")
input.type = "button";
input.value ="Buy Now"
article.append(divImg,h3,h5,input)
div.append(article);
})